...
class InstituteController extends VoyagerBaseController
{
    ...
    public function edit(Request $request, $id)
    {
		...
		$courseForInstitute = [];
		$course_institute = DB::table('course_institute')->where('institute_id',$id)->get();
		
		foreach($course_institute as $course_id){
			$course = Course::find($course_id->course_id);
			if($course){
				$courseForInstitute[] = $course;
			}
		}
		

        return Voyager::view($view, compact('dataType', 'dataTypeContent', 'isModelTranslatable','allCourses','courseForInstitute'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        DB::table('course_institute')->where('institute_id',$id)->delete();
		
		$this->updateInstituteCourse($request,$id);
    ...
    public function store(Request $request)
    {
        ...
        foreach($request->courses as $cat):
            //var_dump($cat);
            $course_institute = DB::table('course_institute')->insert([
                'course_id'=>$cat,
	...
	protected function updateInstituteCourse($request,$id){
		if($request->courses){
			foreach($request->courses as $courses){
                DB::table('course_institute')->insert([
                    'course_id'=>$courses,
                    'institute_id'=> $id
                ]);
			}
